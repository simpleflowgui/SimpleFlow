  ...
  function spawncreatescreen(){
    ...
    newel.addEventListener("click",function(){
      if(document.getElementById("contpopupnodecode")){
        ...
        newel.style.left = "50%";
        newel.style.top = "20%";
        newel.style.width = "38%";
        newel.style.height = "15%";
        document.getElementById("contpopup").append(newel);
        newel = document.createElement("p");
    ...
    newel.addEventListener("change",function(){
      ...
      node.addEventListener("click",function(){
        ...
        if(document.getElementById("contpopupnodecode")){  
          ...
          newelem.style.width = "12%";
          newelem.style.height = "5%";
          ...
          newel.style.width = "48%";
          newel.style.height = "62%";
          newel.style.position = "absolute";
          newel.style.top = "20%";
          newel.style.left = "50%";
    ...
    newel.style.border = "2px solid black";
    newel.style.borderRadius = "5px";
    newel.style.width = "18%";
    newel.style.height = "45%";
    document.getElementById("contpopup").append(newel);
    newel = document.createElement("div");
